...
const Footer = () => {
  return (
    <div className="bg-black w-screen py-10 lg:py-28">
      <div
        className="container grid grid-cols-1 lg:grid-cols-3 justify-items-center
       text-white gap-5"
      >
        ...
        <div>
          <div className="flex items-center justify-end sm:mt-5">
            <p>
